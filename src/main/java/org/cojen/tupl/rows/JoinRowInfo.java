...
final class JoinRowInfo {
     ...
     */
    static JoinRowInfo find(Class<?> joinType) {
    ...
    private static boolean typeCheck(Set<String> messages, String name, Class<?> type) {
        ...
        msg = new StringBuilder().append("column \"").append(type.getSimpleName()).append(' ')
            .append(name).append("\" has an unsupported type").append(": ").append(msg)
            .toString();
        messages.add(msg);
